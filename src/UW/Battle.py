...
class Battle:
    ...
    def suppressBattle(self):
        ...
        continueWithUntilBy(lambda: self.instance.clickPointV2(*self.randomPoint),lambda: self.uwtask.hasSingleLineWordsInArea("ok", A=[632,691,680,714]) or self.uwtask.hasSingleLineWordsInArea("close", A=[632,691,680,714]) or self.uwtask.inCityList(self.uwtask.allCityList),10)
        def exitBattle():
