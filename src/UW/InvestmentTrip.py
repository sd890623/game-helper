...
class Investment:
    ...
    def investInCity(self):
        ...
        self.investOnce()
        while (True):
            xxxp = task.getSingleLineWordsInArea(A=[260,784,312,801],ocrType=3)
